(function () {
  ...
  var jpTextMap = {
    'CSCAM 기계사업부': 'CSCAM機械事業部',
    '금속 분말을 고정밀 파이버 레이저로 녹여 층층이 쌓아 올려, 전통적인 절삭 가공으로는 구현하기 어려운 복잡한 내부 중공 구조나 냉각 유로를 지닌 부품을 처음부터 일체형으로 구현하는': '金属粉末を高精度ファイバーレーザーで溶融し積層造形することで、従来の切削加工では実現が難しい複雑な内部中空構造や冷却流路を持つ部品を最初から一体成形する',
    '금속 3D 프린팅(PBF)': '金属3Dプリンティング(PBF)',
    '라인업입니다. 씨에스캠의 레이저 제어 기술과 실시간 모니터링 시스템을 통해 소형 덴탈 의료 정밀 부품부터 대형 산업 발전 및 원자력 발전용 부품까지 최고 등급의 상대밀도와 신뢰성 있는 인장강도를 확보하며, 장비 크기별 최적화된 4종(AnyX-M180, M250, M400, M1000)의 고성능 금속 적층 제조 라인업을 제공하고 있습니다.': 'ラインナップです。CSCAMのレーザー制御技術とリアルタイムモニタリングシステムにより、小型デンタル医療精密部品から大型産業発電及び原子力発電用部品まで最高等級の相対密度と信頼性の高い引張強度を確保し、設備サイズ別に最適化された4種(AnyX-M180、M250、M400、M1000)の高性能金属積層造形ラインナップを提供しています。',
    'SLM(AnyX) 자세히 보기 →': 'SLM(AnyX)を詳しく見る →',
    '액체 상태의 광경화성 에폭시/아크릴 수지에 고정밀 UV 자외선 레이저를 조사하여 순간적으로 경화시켜 형상을 제조하는': '液体状の光硬化性エポキシ/アクリル樹脂に高精度UV紫外線レーザーを照射して瞬間的に硬化させ造形する',
    '광경화 적층 방식(Stereolithography, SLA)': '光硬化積層方式(Stereolithography, SLA)',
    '라인업입니다. 레이저 가공 분야에서 축적된 미세 스캔 제어 노하우를 접목하여 극도로 매끄러운 조도와 정밀한 치수 공차를 달성할 수 있어 정밀 덴탈 모델, 복잡한 주얼리 마스터 원형, 정밀 주조용 패턴(캐스터블 레진) 제작에 특화되어 있습니다. 소형 정밀형부터 대형 산업용 장비인 AnyX-S150, S300, S600 3가지 기종을 통해 부품 시제품부터 대형 하우징 모크업까지 폭넓은 산업군에 고속 정밀 제조 솔루션을 제안합니다.': 'ラインナップです。レーザー加工分野で蓄積した微細スキャン制御ノウハウを応用し、極めて滑らかな表面粗さと精密な寸法公差を実現できるため、精密デンタルモデル、複雑なジュエリーマスター原型、精密鋳造用パターン(キャスタブルレジン)の製作に特化しています。小型精密機種から大型産業用設備のAnyX-S150、S300、S600の3機種により、部品試作から大型ハウジングモックアップまで幅広い産業分野に高速精密製造ソリューションを提供します。',
    'SLA(AnyX-S) 자세히 보기 →': 'SLA(AnyX-S)を詳しく見る →',
    '02-1 / SLM — 라인업 소개': '02-1 / SLM — ラインナップ紹介',
    '혁신적인 SLM 금속 3D 프린터': '革新的なSLM金属3Dプリンター',
    '최적의 메탈 3D 프린터 솔루션을 제공합니다': '最適な金属3Dプリンターソリューションを提供します',
    'SLM(Selective Laser Melting) 방식의 소형부터 초대형까지, 4가지 라인업의 AnyX 시리즈로 고객의 다양한 요구를 충족하는 최적의 금속 3D 프린터 솔루션을 제공합니다.': 'SLM(Selective Laser Melting)方式の小型から超大型まで、4種類のラインナップのAnyXシリーズでお客様の多様なニーズに応える最適な金属3Dプリンターソリューションを提供します。',
    'CW(연속발진) 파이버 레이저로 금속 분말을 선택적으로 용융시켜 정밀한 3차원 형상을 처음부터 쌓아 올리는': 'CW(連続発振)ファイバーレーザーで金属粉末を選択的に溶融し、精密な三次元形状を最初から積み上げる',
    '적층 제조(Additive Manufacturing)': '積層造形(Additive Manufacturing)',
    '전용 장비입니다.': '専用設備です。',
    '는 정밀 레이저를 탑재한': 'は精密レーザーを搭載した',
    '타입의 금속 3D 프린터로, 소형 마이크로 부품부터 초대형 우주항공 부품까지 폭넓게 제작 가능한 최적의 산업용 라인업을 제공합니다.': 'タイプの金属3Dプリンターで、小型マイクロ部品から超大型航空宇宙部品まで幅広く製作可能な最適な産業用ラインナップを提供します。',
    '02-2 / SLM — 개별 스펙': '02-2 / SLM — 個別スペック',
    'AnyX-M Series 제품 라인업': 'AnyX-M Series 製品ラインナップ',
    '장비사양': '設備仕様',
    '다운로드': 'ダウンロード',
    '문의하기': 'お問い合わせ',
    '{{ activeSpecProduct.name }} 스펙 시트': '{{ activeSpecProduct.name }} スペックシート',
    '상담 및 견적 문의': 'ご相談・お見積り',
    '닫기': '閉じる',
    '2025년 실증선박 탑재 시연완료': '2025年実証船舶搭載デモ完了',
    '02-2b / SLM — 컨테이너형 이동식 SLM': '02-2b / SLM — コンテナ型移動式SLM',
    '40ft 해상 컨테이너 안에 AnyX 계열 SLM 장비와 분말 취급·후처리 설비를 일체화한': '40フィート海上コンテナ内にAnyX系SLM設備と粉末取扱・後処理設備を一体化した',
    '이동식 금속 3D프린팅 올인원 워크샵': '移動式金属3Dプリンティングオールインワンワークショップ',
    '입니다. 특히 선박 운항 중 가해지는': 'です。特に船舶運航中に加わる',
    '진동, 파고, 선체 흔들림(롤링) 등 격렬한 외란을 극복하는 능동형 상쇄 시스템': '振動、波高、船体の揺れ(ローリング)などの激しい外乱を克服する能動型相殺システム',
    '과': 'と',
    '철저한 밀폐식 항온·항습 설비': '徹底した密閉式恒温・恒湿設備',
    '가 내장되어 있어, 실제 해상 환경에서도 육지와 다름없는 우수한 정밀도의 금속 부품을 즉시 생산(MRO)할 수 있도록 실증 검증되었습니다.': 'を内蔵しており、実際の海上環境でも陸上と変わらない優れた精度の金属部品を即座に生産(MRO)できるよう実証検証されています。',
    'ANTI-ROLLING (롤링 상쇄)': 'ANTI-ROLLING(ローリング相殺)',
    '상쇄율 99.70%': '相殺率99.70%',
    '(보정각 ±8°)': '(補正角 ±8°)',
    'ANTI-VIBRATION (진동 감쇄)': 'ANTI-VIBRATION(振動減衰)',
    '감쇄율 84.77%': '減衰率84.77%',
    '(6자유도 검증)': '(6自由度検証)',
    '4단계 자동 온·습도': '4段階自動温・湿度',
    'N₂ 제어': 'N₂制御',
    '선급 Stage 2 인증': '船級Stage 2認証',
    '소화 시스템': '消火システム',
    '※ HD현대삼호중공업 8223호선(HMM GREEN)에 실제 탑재 및 해상 조형 실증 완료 (물성치 확보)': '※ HD現代三湖重工業8223号船(HMM GREEN)に実際搭載及び海上造形実証完了(物性値確保)',
    '내부 설비 구성 — 3DP 메인장치 · 모니터링장치 · 후처리장치': '内部設備構成 — 3DPメインユニット · モニタリングユニット · 後処理ユニット',
    '컨테이너 구동 영상 재생': 'コンテナ稼働動画再生',
    '도면 레이아웃 보기': '図面レイアウトを見る',
    '※ 로컬 브라우저 보안(file://)으로 영상이 재생되지 않는 경우:': '※ ローカルブラウザのセキュリティ(file://)により動画が再生されない場合:',
    '[여기(새 창)를 눌러 영상 직접 열기]': '[ここ(新しいウィンドウ)をクリックして動画を直接開く]',
    '공동연구개발 및 실증 협력 기관': '共同研究開発及び実証協力機関',
    '02-3 / SLM — 파우더 소재': '02-3 / SLM — 粉末材料',
    '검증된 금속 분말과 정밀 관리 시스템': '検証済み金属粉末と精密管理システム',
    '씨에스캠은 대표적으로 Sandvik社의 Osprey® 가스분무(Gas Atomized) 금속 분말을 취급하며, 구형도(Sphericity)와 유동성이 우수해 정밀 레이저 용융(SLM) 공정에 최적화되어 있습니다. 이 외에도 항공·의료·발전 등 산업별로 요구되는 물성에 맞춰 자체 검증을 마친 다양한 소재 옵션을 보유하고 있어, 상담을 통해 부품 사양에 맞는 최적의 소재와 공정 조건을 함께 제안해 드립니다.': 'CSCAMは主にSandvik社のOsprey®ガスアトマイズ(Gas Atomized)金属粉末を取り扱っており、球形度(Sphericity)と流動性に優れ、精密レーザー溶融(SLM)工程に最適化されています。この他にも航空・医療・発電など産業別に求められる物性に合わせて自社検証済みの多様な材料オプションを保有しており、ご相談を通じて部品仕様に合った最適な材料と工程条件をご提案いたします。',
    '분말 관리': '粉末管理',
    '취급 시스템': '取扱システム',
    'POWDER HANDLING · 전 모델 공통 적용': 'POWDER HANDLING · 全モデル共通適用',
    '02-4 / SLM — 응용 분야': '02-4 / SLM — 応用分野',
    'AnyX-M Series 응용 분야': 'AnyX-M Series 応用分野',
    '본 응용 출력물들은 실제 AnyX-M Series를 통해 제작되었습니다': '本応用出力物は実際のAnyX-M Seriesで製作されたものです',
    '02-5 / SLM — 설치사례': '02-5 / SLM — 導入事例',
    'SLM 설치 및 가동 현장': 'SLM設置及び稼働現場',
    '02-6 / SLM — 브랜드 스토리': '02-6 / SLM — ブランドストーリー',
    '10년 이상의 레이저 제어 기술이': '10年以上のレーザー制御技術が',
    'AnyX-M Series에 담겨 있습니다': 'AnyX-M Seriesに込められています',
    '씨에스캠은 레이저 가공 장비 개발 경험을 바탕으로 SLM 방식 금속 3D 프린터의 광학계와 제어 소프트웨어를 정밀하게 구성했습니다. 경희대학교·조선대학교 등 교육기관부터 LG전자·한국원자력연구원 등 산업·연구 현장까지, AnyX-M Series는 실제 가동 현장에서 검증되고 있습니다.': 'CSCAMはレーザー加工設備の開発経験を基に、SLM方式金属3Dプリンターの光学系と制御ソフトウェアを精密に構成しました。慶熙大学・朝鮮大学などの教育機関からLG電子・韓国原子力研究院などの産業・研究現場まで、AnyX-M Seriesは実際の稼働現場で検証されています。',
    '02-7 / SLM — 자료 다운로드': '02-7 / SLM — 資料ダウンロード',
    '03 / SLA — 라인업 소개': '03 / SLA — ラインナップ紹介',
    'SLA 광경화 3D 프린터': 'SLA光硬化3Dプリンター',
    '[ AnyX-S Series ] 데이터 준비 및 업데이트 대기 중': '[ AnyX-S Series ] データ準備及び更新待ち',
    'CAM & 컨트롤 소프트웨어': 'CAM&コントロールソフトウェア',
    'SLM(AnyX)과 SLA(AnyX-S) 전 라인업은 씨에스캠 전용 소프트웨어 환경에서 구동됩니다.': 'SLM(AnyX)とSLA(AnyX-S)の全ラインナップはCSCAM専用ソフトウェア環境で稼働します。',
    '"AnyX 전 라인업 전용 CAM 시스템"': '「AnyX全ラインナップ専用CAMシステム」',
    'AnyX-M Series(SLM)와 AnyX-S Series(SLA)의 조형 데이터 생성, 슬라이싱, 마킹을 하나로 처리하는 씨에스캠 전용 CAM 소프트웨어입니다.': 'AnyX-M Series(SLM)とAnyX-S Series(SLA)の造形データ生成、スライシング、マーキングを一つにまとめて処理するCSCAM専用CAMソフトウェアです。',
    'CS_Laser 3D 매뉴얼 · PDF': 'CS_Laser 3D マニュアル · PDF',
    '비전문가 운용을 위한 7단계 공정 절차': '非専門家でも運用できる7ステップの工程手順',
    '05 / 주요 고객': '05 / 主要顧客',
    '3D 프린터 주요 고객': '3Dプリンター主要顧客',
    '국내 유수의': '韓国を代表する',
    '대기업, 국책 연구기관, 대학교': '大企業、国策研究機関、大学',
    '가 씨에스캠 3D 프린터를 도입해 연구·개발·양산 현장에서 활용하고 있습니다.': 'がCSCAMの3Dプリンターを導入し、研究・開発・量産現場で活用しています。',
    '제품(견적) 문의처 및 사업부 위치': '製品(見積)お問い合わせ先及び事業部所在地',
    '3D 프린터 사업부': '3Dプリンター事業部',
    'Customer Center · 고객센터': 'Customer Center · 顧客センター',
    '상담 전화': 'お問い合わせ電話',
    '상담 시간': '営業時間',
    '오전 08:30 ~ 오후 05:30': '午前08:30 ~ 午後05:30',
    '본사 (전남광주특별시)': '本社(全羅南道光州)',
    '전남광주특별시 광산구 평동산단로 239-15': '大韓民国全羅南道光州広域市光山区平洞産業団地路239-15',
    '씨에스캠주식회사': 'CSCAM株式会社',
    '레이저 제어 기술 기반의 SLM 금속 3D 프린터(AnyX-M Series)와 SLA 광경화 3D 프린터(AnyX-S Series)를 공급합니다.': 'レーザー制御技術に基づくSLM金属3Dプリンター(AnyX-M Series)とSLA光硬化3Dプリンター(AnyX-S Series)を供給します。',
    '기술자료': '技術資料',
    'SLM 응용분야 · 소재': 'SLM応用分野 · 材料',
    'SLA 응용분야 · 레진': 'SLA応用分野 · レジン',
    '홍보자료': '広報資料',
    '설치사례': '導入事例',
    '주요 고객': '主要顧客',
    '제품(견적) 문의': '製品(見積)お問い合わせ',
    '© 2026 씨에스캠주식회사 (CSCAM Co., Ltd.) — 3D Printer Division. All Rights Reserved.': '© 2026 CSCAM株式会社(CSCAM Co., Ltd.) — 3Dプリンター事業部. All Rights Reserved.',
    '본사 · 전남광주특별시 광산구 평동산단로 239-15 · 062-946-1900': '本社 · 大韓民国全羅南道光州広域市光山区平洞産業団地路239-15 · 062-946-1900',
    'CSCAM 문의하기': 'CSCAMへのお問い合わせ',
    '3D PRINTER 상담 챗봇': '3D PRINTER 相談チャットボット',
    '입력 중': '入力中',
    '안녕하세요! 씨에스캠 3D 프린터 상담 챗봇입니다.': 'こんにちは!CSCAM 3Dプリンター相談チャットボットです。',
    '아래 항목을 선택하거나 궁금하신 점을 입력해 주세요.': '下記の項目を選択するか、ご質問を入力してください。',
    'AnyX-M Series(SLM) 스펙이 궁금해요': 'AnyX-M Series(SLM)のスペックが気になる',
    'AnyX-S Series 문의': 'AnyX-S Seriesについて問い合わせ',
    '담당자 연결 (062-946-1900)': '担当者につなぐ (062-946-1900)',
    '선택해 주셔서 감사합니다! 상세 자료 송부 및 정확한 기술 상담을 도와드리기 위해 먼저 고객님의': 'ご選択ありがとうございます!詳細資料の送付及び正確な技術相談のため、まずお客様の',
    '성함(회사명)': 'お名前(会社名)',
    '을 아래 입력창에 작성해 주세요.': 'を下記の入力欄にご記入ください。',
    '성함 또는 회사명을 입력하세요...': 'お名前または会社名を入力してください...',
    '전화번호 또는 이메일을 입력하세요...': '電話番号またはメールアドレスを入力してください...',
    '상세 요구사항을 입력하세요...': '詳細なご要望を入力してください...',
    '메시지를 입력하세요 (준비 중)': 'メッセージを入力してください(準備中)',
    '접수가 성공적으로 완료되었습니다.': '送信が正常に完了しました。',
    '처음 단계로 돌아가기': '最初のステップに戻る'
  };

  var jpAttrMap = {
    '국내 최대 산업용 SLM 3D프린터 라인업 및 선박용 컨테이너형 적층제조 실증사례.': '韓国最大級の産業用SLM 3Dプリンターラインナップ及び船舶用コンテナ型積層造形実証事例。',
    'SLM 조형 과정 구동': 'SLM造形過程アニメーション',
    'SLA 조형 과정 구동': 'SLA造形過程アニメーション',
    '선박 탑재 컨테이너형 3DP 실사진': '船舶搭載コンテナ型3DP実写真',
    '컨테이너 내부 설비 구성도': 'コンテナ内部設備構成図',
    '공동연구개발 및 실증 협력 기관': '共同研究開発及び実証協力機関',
    'CS_Laser 3D 소프트웨어': 'CS_Laser 3D ソフトウェア',
    'CS_Laser 3D 소프트웨어 UI 화면': 'CS_Laser 3D ソフトウェアUI画面',
    '씨에스캠 본사 위치': 'CSCAM本社所在地',
    '맨 위로': 'トップに戻る',
    '메시지를 입력하세요 (준비 중)': 'メッセージを入力してください(準備中)'
  };
  ...
  function applyAutoText(root) {
    ...
    var aMap = window.LANG === 'zh' ? zhAttrMap : window.LANG === 'jp' ? jpAttrMap : attrMap;
